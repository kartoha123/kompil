...
bool ChekOfBorder(char Symbol){
    if (Symbol == '=' or Symbol == ' ' or Symbol == '"' or Symbol == '+' or Symbol == '-' or Symbol == '*' or Symbol == '/' or Symbol == '%' or Symbol == ';' or Symbol == '(' or Symbol == ')' or Symbol == '{' or Symbol == '}' or Symbol == '<' or Symbol == '>' or Symbol == '!' or Symbol == '|' or Symbol == '&' or Symbol == '\0' or Symbol == '\t')
        return true;
    else return false;
}
...
void ComparisonAndWriter(string inText, int NumStr){
    ...
    bool point = false;
    int j = 0;
    if ((inText.length() != 0) && (inText[0] != ' ') &&(inText[0] != '\0') &&(inText[0] != '\t'))
